...
function App(props) {
  ...
  const content = useMemo(() => homeData?.wordPress?.hPage?.homePageRedesignUK, []);
  ...
  console.log('seo meta', homeData.wordPress.hPage.seo)
  console.log('page language', homeData.wordPress.hPage.hPageLanguage.pageLanguage)
  ...
  return (
    ...
    <Carousel
          ...
          keyBoardControl
          >
            <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/jlo-beauty/" aria-label="Open in a new window">
        ...
        <img
         ...
         <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/sonos/" aria-label="Open in a new window">
            <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
          ...
          />
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/clarks/" aria-label="Open in a new window">
              <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
          ...
          />
            ...
            <Arrow className="brands-card-arrow" dark/>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/case-mate/" aria-label="Open in a new window" tabIndex="-1">
              <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
          ...
          />
            ...
            <Arrow className="brands-card-arrow" dark/>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/clarins/" aria-label="Open in a new window" tabIndex="-1">
              <div className="brands-carousel-image-logo-container">
        ...
        <img
          ...
          />
            <img
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/koio/" aria-label="Open in a new window" tabIndex="-1">
              <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
          ...
          />
            ...
            <Arrow className="brands-card-arrow" dark/>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/rag-and-bone/" aria-label="Open in a new window" tabIndex="-1">
              <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
          ...
          />
            ...
            <Arrow className="brands-card-arrow" dark/>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/j-mclaughlin/" aria-label="Open in a new window" tabIndex="-1">
              <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
          ...
          />
            ...
            <Arrow className="brands-card-arrow" dark/>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/refinery29/" aria-label="Open in a new window" tabIndex="-1">
              <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
          ...
          />
            ...
            <Arrow className="brands-card-arrow" dark/>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/weather-com/" aria-label="Open in a new window" tabIndex="-1">
              <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
          ...
          />
            ...
            <Arrow className="brands-card-arrow" dark/>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/uk/resources/case-studies/facegym/" aria-label="Open in a new window" tabIndex="-1">
              <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
          ...
          />
            ...
            <Arrow className="brands-card-arrow" dark/>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.wunderkind.co/resources/case-studies/natural-baby-shower/" aria-label="Open in a new window" tabIndex="-1">
              <div className="brands-carousel-image-logo-container">
        <img
          className="brands-carousel-logo"
    ...
    <div className="cookie-page-container">
        ...
        <div className="cookie-page-numbers-container">
          ...
          <div className="cookie-page-numbers-wrapper-2">
            ...
            <h3 className="cookie-page-small-description-2">{content.cookiepagesmalldescription2}</h3>
        ...
        className={`cookie-page-cookie-image ${isCookieImageVisible ? 'fade-in' : ''}`}
          ...
          <div className="cookie-page-header-button-container">
            ...
            <Button href="https://www.wunderkind.co/uk/how-it-works/performance-marketing-solutions-for-ecommerce/" className="btn-fill cookie-page-cta-button">{content.cookiepagectabutton}</Button>
          </div>
    </div>
    ...
    <div className="weunderstand-page-container">
