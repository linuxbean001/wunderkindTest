...
function formatParticipantsData(participants) {
  return (
    ...
    participants.map(participant => ({
      firstName: participant.pcSpeakerFirstName,
      lastName: participant.pcSpeakerLastName,
      companyPosition: participant.pcCompanyPosition,
      linkedinUrl: participant.pcSpeakerLinkedinUrl,
      sourceUrl: participant.pcSpeakerImage.sourceUrl,
      altText: participant.pcSpeakerImage.altText,
    }))
  );
}
...
function getPodcastData(podcast) {
  ...
  return {
    heroTitle: pcHeroTitle,
    heroSubtitle: pcHeroSubtitle,
    heroVideoSrc: pcHeroVideo,
    keyTakeawaysNumber: pcAmountOfKeyTakeaways,
    participantsSectionTitle: pcSpeakerTitle,
    participantsInfo: formatParticipantsData(pcSpeaker),
    recommendedSectionTitle: pcRecommendedTitle,
    seo,
