...
function getContentSectionData(data) {
  return (
    data &&
    data.hPlainContentFieldsUk &&
    data.hPlainContentFieldsUk.ukBuildingArea
  );
}
    ...
    >
      {sections &&
        sections.map((section, index) => {
          ...
          switch (type) {
            case "WordPress_HPage_Hplaincontentfieldsuk_UkBuildingArea_Intro":
              return (
                <Intro
                  key={"section-" + index}
            ...
            case "WordPress_HPage_Hplaincontentfieldsuk_UkBuildingArea_Content":
              return (
                <SideHtmlTextContent
                  key={"section-" + index}
...
export const query = graphql`
  query plainContentUkQuery($id: ID!) {
    wordPress {
      hPageBy(id: $id) {
        databaseId
        title
        ...
        hPlainContentFieldsUk {
          ukBuildingArea {
            ... on WordPress_HPage_Hplaincontentfieldsuk_UkBuildingArea_Intro {
              bodyCopy
              ctaGroup {
                text
                url
            ...
            ... on WordPress_HPage_Hplaincontentfieldsuk_UkBuildingArea_Content {
              pageContent
            }
          }
        }
